        ...
        >
          <Box flexGrow={1}>
            <Grid
              ...
              sx={{
                background:
                  "linear-gradient(to right,#ff9902, #e77401)", // Base grid background color
            ...
            >
              <Grid item xs={4} align="center">
                <Avatar
                  src="https://91club.bet/assets/png/1-a6662edb.png"
                ...
                <Grid item xs={12} align="Left">
                  ...
                  >
                    ...
                    <IconButton onClick={handleRefresh}>
                      <AutorenewIcon
                        style={{ color: "#a3a3a3", width: "20", height: "20" }}
                      />
                    </IconButton>
                  </Typography>
                </Grid>
              ...
              <Grid item xs={6}>
                ...
                >
                  <Grid item onClick={() => navigate("/deposit-history")}>
                    <ImageSubtitleGrid
                      imageSrc="/assets/images/download (1).png"
                      subtitle1="Deposit"
            ...
            >
              <Grid container alignItems="center">
                <Grid item>
                  <ExitToAppIcon style={{ color: "#ec8a1f" }} />
                </Grid>
                <Grid item xs={10}>
                  <Typography
                    variant="body1"
                    sx={{ marginLeft: "8px", color: "#ec8a1f" }}
                  >
                    Log Out
                  </Typography>
                </Grid>
