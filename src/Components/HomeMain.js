...
const Home = ({ children }) => {
  ...
  const handleAviatorClick = async () => {
    try {
      ...
      const response = await axios.post(
        "https://dragonclubs.online/redirect-to-second-website",
        {},
        {
  ...
  const menuItems = [
    {
      text: "Lottery",
      icon: "https://ossimg.91admin123admin.com/91club/gamecategory/gamecategory_20240311141426883l.png",
    },
    {
      text: "Popular",
      icon: "https://ossimg.91admin123admin.com/91club/gamecategory/gamecategory_20240311141435wkxx.png",
    },
    {
      text: "Slots",
      icon: "https://ossimg.91admin123admin.com/91club/gamecategory/gamecategory_20240311141445b3ka.png",
    },
    {
      text: "Fishing",
      icon: "https://ossimg.91admin123admin.com/91club/gamecategory/gamecategory_20240311141457h3ts.png",
    },
    {
      text: "PVC",
      icon: "https://ossimg.91admin123admin.com/91club/gamecategory/gamecategory_20240311141515owja.png",
    },
    {
      text: "Casino",
      icon: "https://ossimg.91admin123admin.com/91club/gamecategory/gamecategory_202403111415086ujt.png",
    },
    {
      text: "Sports",
      icon: "https://ossimg.91admin123admin.com/91club/gamecategory/gamecategory_20240311141522uvco.png",
    },
  ];
  ...
  const contentTabs = [
    {
      ...
      description: "Green/Red/Purple",
      description2: "Guess Number",
    },
    {
      title: "K3",
      path: "/k3",
    ...
    },
    {
      ...
      icons: [
        "https://ossimg.9987cw.cc/TC/gamecategory/gamecategory_2023121503353389nc.png",
      ],
      description: "Big/Small/Odd/Even",
      description2: "Guess Number",
    },
  ...
  return (
    <div style={{ position: "relative" }}>
        ...
        >
          <Box flexGrow={1} sx={{ backgroundColor: "rgb(34,39,91)" }}>
            ...
            <Grid
              container
              alignItems="center"
              sx={{ backgroundColor: "rgb(34,39,91)" }}
            >
              ...
              <Box flexGrow={1}>
                {contentTabs.map((tab, index) => (
                  <Box
                    ...
                    mb={2}
                    p={2}
                    bgcolor="background: -webkit-linear-gradient(324.57deg,  #007aff 12.38%, #73A6DC 87.13%);
      ...
      background-color: initial;"
                    ...
                    onClick={() => {
                      setActiveTab(index);
                      if (tab.path === "/redirect-to-second-website") {
                        handleAviatorClick();
                      } else {
